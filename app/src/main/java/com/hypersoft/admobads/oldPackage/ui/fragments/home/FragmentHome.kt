package com.hypersoft.admobads.oldPackage.ui.fragments.home
...
import com.hypersoft.admobads.oldPackage.adsconfig.natives.AdmobNative
...
import com.hypersoft.admobads.oldPackage.adsconfig.rewarded.AdmobRewarded
...
import com.hypersoft.admobads.oldPackage.helpers.listeners.RapidSafeListener.setOnRapidClickSafeListener
import com.hypersoft.admobads.oldPackage.ui.activities.MainActivity2
...
class FragmentHome : BaseFragment<FragmentHomeBinding>(R.layout.fragment_home) {
    ...
    override fun onViewCreatedOneTime() {
        binding.mbClickSample.setOnRapidClickSafeListener {
            ...
            (activity as MainActivity2).checkCounter()
        }
